Feature: Transfer
   ...
   Scenario Outline: Transfer funds from DAO 
    ...
    When typing "pocket gov transfer <amount> <DAO Address> <ChainID>  <fees>"
      | pocket gov transfer 100000 abf1df709a0cc486ac6db216ba9ed260e5597ba9 1445e7a38aaf8b78440366f5b7af97fdef3e3b1f testnet pocket gov transfer abf1df709a0cc486ac6db216ba9ed260e5597ba9 1445e7a38aaf8b78440366f5b7af97fdef3e3b1f testnet 100000 |
    And hitting enter
   ...
   Scenario Outline: Transfer funds from DAO, wrong address 
    ...
    And a DAO address
    When typing "pocket gov transfer <amount> <DAO Address> <ChainID>  <fees>"
      | pocket gov transfer 100000 c993cbc7d29eb94e6429eee2268b6937ce67d75f abf1df709a0cc486ac6db216ba9ed260e5597ba9 testnet pocket gov transfer abf1df709a0cc486ac6db216ba9ed260e5597ba9 1445e7a38aaf8b78440366f5b7af97fdef3e3b1f testnet 100000 |
    Then user should be prompted to enter its passphrase: "Enter Passphrase: "
    When passphrase is provided
...
Usage:
  pocket gov transfer <amount> <fromAddr> <toAddr> <chainID> <fees> [flags]
